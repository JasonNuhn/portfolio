...
export default scene => {
    ...
    const subjectGeometry = deformGeometry(new THREE.DodecahedronGeometry(10, 2));
    ...
    function update(time) {
        ...
        subjectWireframe.material.color.setHSL( Math.sin(angle*2), 0.4, 0.4);
